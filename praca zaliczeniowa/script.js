...
function validProject(element, let) {
...
function functionButton() {
    ...
    console.log(technologieValidate);
    ...
    if (technologieValidate < 1 || titleValidate < 3 || titleValidate > 30) {
        ...
        if (titleValidate < 3) {
            ...
            inputTitleProject.style.borderBottom = "red 2px solid";
        }
        function updateValue(e) {
            ...
            if (titleValidate < 3) {
                ...
                spanTitle.textContent = " ";
                inputTitleProject.style.borderBottom = "black 2px solid";
            }
        }
        ...
        if (technologieValidate < 1) {
            ...
            inputTechnologies.style.borderBottom = "red 2px solid";
        }
        function validTechnology(e) {
            ...
            if (technologieValidate < 1) {
                ...
                spanTechnology.textContent = " ";
                inputTechnologies.style.borderBottom = "black 2px solid";
            }
        }
    } else {
...
function buttonDiv() {
    ...
    if (
        ...
        if (screen.width > 1023) {
            ...
            imgButtonArrowLeft.src = "./vector/buttonArrowLeft.png";
            imgButtonArrowLeft.alt = "Arrow Left";
            imgButtonArrowRight.src = "./vector/buttonArrowRight.png";
            ...
            imgButtonArrowLeft.src = "./vector/buttonArrowDown.png";
            imgButtonArrowLeft.alt = "Arrow Down";
            imgButtonArrowRight.src = "./vector/buttonArrowUp.png";
...
function hamburgerMenu() {
    if (imgHamburgerMenu.textContent === "whiteHamburger") {
        ...
        console.log(imgHamburgerMenu.src);
